...
def test_import():
    ...
    assert spectral_pipeline.__version__ == "2.0.0"
...
def test_core_modules():
    ...
    from spectral_pipeline.evaluation import metrics
...
def test_convergence_bound():
    """Test convergence bound computation."""
    from spectral_pipeline.math_core.statistics import convergence_bound
    
    bound_100 = convergence_bound(100)
    bound_1000 = convergence_bound(1000)
    
    assert bound_1000 < bound_100  # Bound should decrease with N
    assert bound_100 > 0